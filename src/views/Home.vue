        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La gerencia financiera gestiona los recursos económicos de una empresa para maximizar su valor. Incluye planificación, financiamiento, control del capital de trabajo y evaluación de inversiones. Además, integra principios de sostenibilidad y responsabilidad social, alineando las decisiones con criterios ambientales y éticos. Los estados financieros reflejan la situación económica y permiten tomar decisiones estratégicas. Su análisis mediante indicadores y métodos como el análisis horizontal y vertical facilita la optimización de costos y la mejora de rentabilidad, garantizando liquidez y estabilidad en un entorno competitivo y dinámico.
